...
// Vercel ke liye ye line add karein (Lekin iske liye 'app' ko function se bahar define karna hoga)
// Ya fir sabse simple solution: Pure code ko 'api/index.ts' mein move kar dein.
